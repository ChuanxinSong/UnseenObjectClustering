...
if __name__ == '__main__':
    ...
    network = networks.__dict__[args.network_name](1, cfg.TRAIN.NUM_UNITS, network_data).cuda(device=cfg.device)
    ...
    if args.pretrained_crop:
        ...
        network_crop = networks.__dict__[args.network_name](1, cfg.TRAIN.NUM_UNITS, network_data_crop).cuda(device=cfg.device)
