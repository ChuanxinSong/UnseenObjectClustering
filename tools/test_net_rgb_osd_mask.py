...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="/media/user/data1/rcao/result/uois/OSD/UCN_rgb_mask",
...
def test_segnet(network, output_dir, network_crop):
    ...
    data_root = '/media/user/data1/dataset/OSD'
    ...
    for item in data_list:
        ...
        depth_path = image_path.replace('/rgb/', '/pcd/')
        anno_path = image_path.replace('/rgb/', '/annotation/')
    ...
    for i, (rgb_path, depth_path, anno_path) in enumerate(zip(tqdm(image_paths), depth_paths, anno_paths)):     
        image_dir, image_name = '', os.path.basename(rgb_path).split('.')[0]
...
if __name__ == '__main__':
    ...
    output_dir = '/home/user/scx/Code/UnseenObjectClustering/output/tabletop_object/OSD'
