...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="/media/user/data1/rcao/result/uois/OCID/UCN_rgb_mask",
...
def test_segnet(network, output_dir, network_crop):
    ...
    data_root = '/media/user/data1/dataset/OCID'
    ...
    for item in data_list:
        ...
        anno_path = image_path.replace('/rgb/', '/label/')
    ...
    for i, (rgb_path, depth_path, anno_path) in enumerate(zip(tqdm(image_paths), depth_paths, anno_paths)):     
        ...
        # print(image_dir)
        image_dir = os.path.join(*rgb_path.split('/')[rgb_path.split('/').index("OCID") + 1:-2])
        print(image_dir)
...
if __name__ == '__main__':
    ...
    output_dir = '/home/user/scx/Code/UnseenObjectClustering/output/tabletop_object/OCID'
